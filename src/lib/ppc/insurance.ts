...
export const insuranceServices = [
  ...
  { icon: "heart", title: "Sedation & Comfort", body: "All patients are welcome to ask about sedation. Nitrous oxide is provided by your dentist. IV sedation is administered and monitored by a board-eligible anesthesiologist. Missouri Medicaid is accepted for sedation cases; eligibility and benefits need to be checked.", cta: "Ask about comfort", location: "svc-sedation" },
] as const;
