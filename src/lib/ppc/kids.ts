...
export const kidsFaqs: FaqItem[] = [
  ...
  { question: "Do you take our insurance or Medicaid?", answer: "Call with your plan details to discuss the process for checking benefits. Medicaid is accepted specifically for sedation dentistry, with eligibility and benefits verified before treatment. Ask the office to check coverage for routine visits separately. CareCredit is available subject to credit approval." },
